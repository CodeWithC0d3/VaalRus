...
namespace vaalrusGUIPrototype
{
    public partial class frmReport : Form
    {
        ...
        public void loadDSet()
        {
            ...
            SqlCommand myComm2 = new SqlCommand("SELECT TOP 10 Accommodation_ID, Common_Name, AccommodationType FROM viewBookingReport1 where startDate >= '" + selectStart + "' AND startDate < '" + selectEnd + "' GROUP BY Accommodation_ID, AccommodationType, Common_Name ORDER BY  count(*) DESC ;", conn);
